    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &irobotBase::velCallback, this);
    nh_private.getParam("linear_scale", linear_scale_);
    
    //ROS_INFO("linear_scale_: %f", linear_scale_);
}

void irobotBase::velCallback(const irobot_msgs::Velocities& vel)
{
